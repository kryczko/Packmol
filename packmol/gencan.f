...
c                    parameters. What might be important here
c                    is the setup of the constraint_axis constraint.
c
...
c Setup upper and lower bounds for variables. Usually there are none,
c but one might want to restrict the rotation of the molecules in one
c or more axis
